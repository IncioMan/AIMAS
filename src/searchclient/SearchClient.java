...
public class SearchClient {
	...
	public List<boolean[]> walls = new ArrayList();
	public List<char[]> goals = new ArrayList();
	...
	public SearchClient(BufferedReader serverMessages) throws Exception {
		...
		while (!line.equals("")) {
			boolean[] wall = new boolean[line.length()];
			char[] goal = new char[line.length()];
			...
			// System.err.println("Walls: " + (int) walls.size() + wall.toString());
			// System.err.println("Goals: " + (int) goals.size() + goal.toString());

			line = serverMessages.readLine();
			row++;
		}
		this.initialState.setWalls(this.walls);
		this.initialState.setGoals(this.goals);
	}
